...
The data was loaded into a data frame, but it has to be a data matrix to make your heatmap. The code chunk will be used to transform *wh* data frame into a data matrix.
...
# 9.5 Creating Interactive Heatmap
